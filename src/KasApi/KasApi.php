 ...
 * @method get_sambausers( array $params )
...
class KasApi {
    ...
    protected $functions = array(
        ...
        'update_ssl' => 'hostname!, ssl_certificate_sni_key!, ssl_certificate_sni_crt!, ssl_certificate_is_active, ssl_certificate_force_https, ssl_certificate_sni_csr, ssl_certificate_sni_bundle',
